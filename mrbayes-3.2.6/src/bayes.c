...
//  defaultModel.brlensDir[1] = 20.0;                   /* 2nd param of invGamDir prior  */
    ...
    strcpy(defaultModel.popSizePr, "Uniform");            /* prior on coalescence population size         */
    defaultModel.popSizeFix = 100.0;                    /* N_e = 100 */
    defaultModel.popSizeUni[0] = 0.0;
    defaultModel.popSizeUni[1] = 10000.0;
    ...
    defaultModel.popSizeGamma[0] = 5.0;                 /* exponential with mean 1/10 = 0.1 */
    defaultModel.popSizeGamma[1] = 0.01;
